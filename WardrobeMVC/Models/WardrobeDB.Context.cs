...
namespace WardrobeMVC.Models
{
    ...
    public partial class WardrobeDBEntities : DbContext
    {
        ...
        public virtual DbSet<ArmAccessory> ArmAccessories { get; set; }
        public virtual DbSet<Bottom> Bottoms { get; set; }
        public virtual DbSet<HeadAccessory> HeadAccessories { get; set; }
        public virtual DbSet<NeckAccessory> NeckAccessories { get; set; }
